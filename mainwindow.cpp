...
void MainWindow::initUiTopHLayout()
{
    ...
    leftManualStandSpacer = new QSpacerItem(100, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    manualStandButton->setStyleSheet(styles.standTypeButtons);
    ...
    leftSwitchStandSpacer = new QSpacerItem(10, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    rightSwitchStandSpacer = new QSpacerItem(10, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    autoStandButton->setStyleSheet(styles.standTypeButtons);
    ...
    switchThemeSpacer = new QSpacerItem(40, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
    topHLayout->addItem(switchThemeSpacer);
