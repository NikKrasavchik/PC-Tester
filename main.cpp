...
//		2.3 PCan = "C:\Program Files (x86)\PCAN-Basic" в этой папке должны находится папки "include", "x64" и все остальные ресурсы SDK.
//	  ПОСЛЕ ЭТОГО ПРОЕКТ ДОЛЖЕН СОБРАТЬСЯ ДЛЯ ПЛАТФОРМЫ x64
//	  Отличия в версии Qt может даввть большое количество ошибок 
// 
// 
//    Приложение написано на языке C++ в редакторе Visual Studio c со стандартом ISO C++ 14, использованием графики QT и SDK: canlib, marathon, PCan
//    Стандарт C++:                 ISO C++ 14
