...
// ------------------------------------
// Name: prepareItem
//		Ïîäãîòîâêà ÿ÷åéêè äëÿ çàïèñè â íåãî äàííûõ
// Variables: 
//			int row: èíäåêñ ñòðî÷êè ÿ÷åéêè
//			int column: èíäåêñ ñòîëáöà ÿ÷éêè
//			int rowSpan: êîëè÷åñòâî ÿ÷åéåê äëÿ ãîðèçîíòàëüíîãî ñîåäèíåíèÿ
//			int columnSpan: êîëè÷åñòâî ÿ÷åéóê äëÿ âåðòèêàëüíîãî ñîåäèíåíèÿ
// ------------------------------------
...
// ------------------------------------
// Name: setValues
//		Çàïèñü çíà÷åíèé êàáåëÿ â òàáëèöó
// ------------------------------------
...
// ------------------------------------
// Name: resetLanguage
//		Îáíîâëåíèå äàííûõ â ÿ÷åéêàõ ïîä àêòóàëüíûé ÿçûê
// Variables: 
//			int offset: Çíà÷åíèå ñìåùåíèÿ. Ïî óìîë÷àíèþ OFFSET_NULL
// ------------------------------------
...
void MoreWindow::resaveFile()
{
	...
	QString config = fin.readLine(); // Îáðåçàåè è çàïîìèíàåì ðàçäåë ôàéëà ñ èíôîðìàöèåé î  CONFIG
	config += fin.readLine();
	...
	while (!fin.atEnd()) // Ïîñèê íóæíîãî ìåñòà â ôàéëå è èçìåíåíèå åãî â ñîîòâåòñòâèå ñ ïðàâêàìè ïîëüçîâàòåëÿ
	{
	...
	outputString.insert(0, config); // Âñòàâëÿåì â íà÷àëî ñòðîêè èíôîðìàöèþ î ðàçäåëå CONFIG
	fin.close();

	if (!isFound) // Åñëè íå íàéäåí íóæíûé êàáåëü
	{
...
#endif // QT_5
	// Ïåðåçàïèñü ñ íîâûìè çíà÷åíèÿìè
	std::ofstream fout;
